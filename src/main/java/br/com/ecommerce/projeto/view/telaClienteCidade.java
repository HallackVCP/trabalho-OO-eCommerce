 ...
 * @author vinib
 */
public class telaClienteCidade extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaClienteCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
